...
st.markdown(
    ...
    /* Colore UNICO per entrambi i bottoni cliccabili (dall'hub) - MODIFICATO */
    .app-button-link {
            ...
            def get_farmadati_mapping(_username, _password):
                ...
                try:
                    ...
                    with tempfile.TemporaryDirectory() as tmp_dir:
                        ...
                        # Parse the large XML file efficiently
                        ...
                        for event, elem in context:
                            if elem.tag == 'RECORD':
                                ...
                                # Clear the element to save memory after processing
                                elem.clear()
